...
- ~~**FR-032**: System MUST provide a home feed composed of posts from the interests a person follows.~~ — **WITHDRAWN AS WRITTEN 2026-09-08 by 007 (RS-008).** The home feed is RANKED from behaviour, not composed from subscriptions. Following an interest survives as a standing declaration that feeds the ranking (007/FR-030): it changes the ORDER of a feed drawn across the whole catalogue, never its membership.
